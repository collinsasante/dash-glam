          ...
          <div className="card">
            <div className="card-body p-10">
              <div className="text-center">
                <i className="ki-duotone ki-chart-simple fs-5x text-info mb-5">
                  <span className="path1"></span>
                  <span className="path2"></span>
                  <span className="path3"></span>
                  <span className="path4"></span>
                </i>
                <h3 className="text-gray-900 fw-bold mb-3">Reports & Analytics</h3>
                <p className="text-muted fs-5">
                  Business intelligence and reporting features will be implemented here.
                </p>
              </div>
            </div>
          </div>
